...
H264ENC_C_SRCS=\
	$(H264ENC_SRCDIR)/src/encoder.c\

H264ENC_OBJS = $(H264ENC_C_SRCS:.c=.$(OBJ))

OBJS += $(H264ENC_OBJS)

$(H264ENC_SRCDIR)/%.$(OBJ): $(H264ENC_SRCDIR)/%.c
	$(QUIET_CXX)$(CXX) $(CFLAGS) $(INCLUDES) $(H264ENC_CFLAGS) $(H264ENC_INCLUDES) -c $(CXX_O) $<

h264enc_simple$(EXEEXT): $(H264ENC_OBJS) $(H264ENC_DEPS)
	$(QUIET_CXX)$(CXX) $(CXX_LINK_O) $(H264ENC_OBJS) $(H264ENC_LDFLAGS) $(LDFLAGS)

binaries: h264enc_simple$(EXEEXT)
BINARIES += h264enc_simple$(EXEEXT)
